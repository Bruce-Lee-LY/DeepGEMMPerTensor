...
jit_include_dirs = ('deep_gemm_per_tensor/include/deep_gemm_per_tensor', )
...
class PostDevelopCommand(develop):
    ...
    def make_jit_include_symlinks():
        ...
        for d in third_party_include_dirs:
            ...
            dst_dir = f'{current_dir}/deep_gemm_per_tensor/include/{dirname}'
...
class CustomBuildPy(build_py):
    ...
    def prepare_includes(self):
        ...
        build_include_dir = os.path.join(
            self.build_lib, 'deep_gemm_per_tensor/include')
...
if __name__ == '__main__':
    ...
    setuptools.setup(
        name='deep_gemm_per_tensor',
        version='1.0.0' + revision,
        packages=['deep_gemm_per_tensor', 'deep_gemm_per_tensor/jit',
                  'deep_gemm_per_tensor/jit_kernels'],
        package_data={
            'deep_gemm_per_tensor': [
                'include/deep_gemm_per_tensor/*',
                'include/cute/**/*',
                'include/cutlass/**/*',
            ]
        },
